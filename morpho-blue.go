...
var MorphoMarketIDMapList = map[string]map[string]map[string][]string{
	chainId.EthereumChainName: {
		...
		WBTCList[chainId.EthereumChainName]: {
			USDCList[chainId.EthereumChainName]: {
