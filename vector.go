...
var VectorMachinegunPoolList = map[string]map[string]string{
	chainId.AvalancheChainName: {
		...
		VectorPoolNameList[chainId.AvalancheChainName][Platypus_AVAX_yyAVAX_PairName][WAVAXList[chainId.AvalancheChainName]]:  "0x0c5c01c13ff73e01c649628c2aea96cd09d359ae",
