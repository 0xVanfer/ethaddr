...
var VectorMachinegunPoolList = map[string]map[string]string{
	chainId.AvalancheChainName: {
		...
		VectorPoolNameList[chainId.AvalancheChainName][Platypus_AVAX_sAVAX_PairName][BenqiSAVAXList[chainId.AvalancheChainName]]: "0x812b7c3b5a9164270dd8a0b3bc47550877aecdb1",
	},
}
