...
var VectorMachinegunPoolList = map[string]map[string]string{
	chainId.AvalancheChainName: {
		...
		VectorPoolNameList[chainId.AvalancheChainName][Platypus_AVAX_sAVAX_PairName][WAVAXList[chainId.AvalancheChainName]]:   "0xab42ed09F43DDa849aa7F62500885A973A38a8Bc",
		...
		VectorPoolNameList[chainId.AvalancheChainName][Platypus_AVAX_yyAVAX_PairName][WAVAXList[chainId.AvalancheChainName]]:  "0xaf224fd9cf65e869e150013529694be18be7b418",
		VectorPoolNameList[chainId.AvalancheChainName][Platypus_AVAX_yyAVAX_PairName][YyAVAXList[chainId.AvalancheChainName]]: "0xf3876553724471ea85e58c0b0d1ec7c4b4147bdf",
