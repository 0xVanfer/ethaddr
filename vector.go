...
var VectorPoolNameList = map[string]map[string]map[string]string{
	chainId.AvalancheChainName: {
		...
		PlatypusAVAXsAVAXPairName: {
			...
			BenqiSAVAXList[chainId.AvalancheChainName]: "SAVAX",
		},
		PlatypusUSDCTUSDPairName: {
...
var VectorMachinegunPoolList = map[string]map[string]string{
	chainId.AvalancheChainName: {
		...
		VectorPoolNameList[chainId.AvalancheChainName][PlatypusUSDCYUSDPairName][USDCList[chainId.AvalancheChainName]]:        "0x7550b2d6a1f039dd6a3d54a857fefcbf77213d80",
		VectorPoolNameList[chainId.AvalancheChainName][PlatypusUSDCYUSDPairName][YUSDList[chainId.AvalancheChainName]]:        "0xbd6a6a5bdb0ca1d5142519fb21b021109414bd1c",
		VectorPoolNameList[chainId.AvalancheChainName][PlatypusUSDCMIMPairName][USDCList[chainId.AvalancheChainName]]:         "0x711a2aaf789ae342f3bf0ac290994f45408e694d",
		VectorPoolNameList[chainId.AvalancheChainName][PlatypusUSDCMIMPairName][MIMList[chainId.AvalancheChainName]]:          "0x222ea06ff0a6d11fc1ef30b5d294e5e71e837caa",
		VectorPoolNameList[chainId.AvalancheChainName][PlatypusUSDCFRAXPairName][USDCList[chainId.AvalancheChainName]]:        "0x1338b4065e25ad681c511644aa319181fc3d64cc",
		VectorPoolNameList[chainId.AvalancheChainName][PlatypusUSDCFRAXPairName][FRAXList[chainId.AvalancheChainName]]:        "0xccce9e28fe4ceff031fd3b8837cb569cfb7a6843",
		VectorPoolNameList[chainId.AvalancheChainName][PlatypusAVAXsAVAXPairName][WAVAXList[chainId.AvalancheChainName]]:      "0xff5386af93cf4bd8d5aecad6df7f4f4be381fd69",
		VectorPoolNameList[chainId.AvalancheChainName][PlatypusAVAXsAVAXPairName][BenqiSAVAXList[chainId.AvalancheChainName]]: "0x812b7c3b5a9164270dd8a0b3bc47550877aecdb1",
	},
}
